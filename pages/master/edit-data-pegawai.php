...
<?php
	...
	if ($_POST['edit'] == "edit") {
		...
		$update= mysql_query ("UPDATE tb_pegawai SET nama='$nama', jk='$jk', tmp_lhr='$tmp_lhr', tgl_lhr='$tgl_lhr', gol_darah='$gol_darah', agama='$agama', status='$status', telp='$telp', alamat='$alamat' WHERE nip='$nip'");
		if($update){
